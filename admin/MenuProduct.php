...
<tr id="tieude">
  ...
  <tr>
    ...
    <select  name="parent" class="input_text" >
      ...
      <?php CategoryParent($_POST['id'],menu_product)?>
    </select></td>
  </tr> 
  <tr>
...
<?php if($_GET['Edit']!='') {?>
 <?php $sqlstr=mysql_query("SELECT * FROM ".menu_product."  WHERE id='".intval($_GET['Edit'])."'");
...
<tr id="tieude">
  ...
  <tr>
    ...
    <select name="parent" class="input_text" >
    <option value="0">Không thuộc nhóm nào</option>
		<?php CategoryParent($row['parent'],menu_product)?>
	</select></td>
    </tr>
  <tr>
    <td class="height_row"><div align="right">Số TT</div></td>
